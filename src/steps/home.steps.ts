...
export class HomeSteps {
    ...
    async clickTestCases(logger: TestAutomationLogger, homePage: HomePage): Promise<void> {
        logger.info('Clicking "Test Cases" in home page');
        await test.step('Click "Test Cases" in home page', async () => {
