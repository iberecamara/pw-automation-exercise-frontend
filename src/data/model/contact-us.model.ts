...
export function GenerateRandomContactUsData(
    options?:
        {
    ...
    return {
        ...
        subject: options?.subject ? options.subject : faker.company.catchPhraseDescriptor(),
        message: options?.message ? options.message : faker.lorem.words({ min: 10, max: 30 }),
